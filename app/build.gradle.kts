...
val uploadKeyPropertiesFile = rootProject.file("release-secrets/upload-key.properties")
...
android {
    namespace = "com.magicclipboard"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.cyberpat.clipkeeper"
        minSdk = 29
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"

        testInstrumentationRunner = "com.magicclipboard.app.HiltTestRunner"
    ...
    signingConfigs {
        if (uploadKeyPropertiesFile.isFile) {
            create("release") {
                storeFile = rootProject.file("release-secrets/magicclipboard-upload.jks")
